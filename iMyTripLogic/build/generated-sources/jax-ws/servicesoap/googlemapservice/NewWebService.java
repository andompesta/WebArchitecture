 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://googleMapService.serviceSoap/", wsdlLocation = "http://localhost:8080/iMyTripService/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://googleMapService.serviceSoap/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/iMyTripService/NewWebService?wsdl");
     ...
     *     returns SOAPGoogle
     */
    @WebEndpoint(name = "SOAPGooglePort")
    public SOAPGoogle getSOAPGooglePort() {
        return super.getPort(new QName("http://googleMapService.serviceSoap/", "SOAPGooglePort"), SOAPGoogle.class);
    }
     ...
     */
    @WebEndpoint(name = "SOAPGooglePort")
    public SOAPGoogle getSOAPGooglePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://googleMapService.serviceSoap/", "SOAPGooglePort"), SOAPGoogle.class, features);
    }
